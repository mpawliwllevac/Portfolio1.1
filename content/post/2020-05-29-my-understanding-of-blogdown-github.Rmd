...
```{r echo=FALSE}
#I've had issues getting images to line up. originally images were pulled from 
# "C:\Users\Matthew\Dropbox\R Working Directory\Portfolio1.1\public\post\2020-05-29-my-understanding-of-blogdown-github_files"
# but for some reason it stopped working. I copied the ..._files folder into content\post and upon refreshing the images worked again
#eventually i noticed the folder was gone but the site was still working. this is ok
```
